...
const PostInputIcon: FC<PostInputIconProps> = ({ inputType, size, disabled, onClick }) => {
  ...
  return (
    <>
      {
        inputType === 'password' ? (
          <svg fill="#000000" version="1.1" id="Capa_1" xmlns="http://www.w3.org/2000/svg"
            width="16px" height="16px" viewBox="0 0 442.04 442.04" className={postIconClassNames} onClick={onClick}>
            <g>
              <g>
    ...
    s12.5,5.597,12.5,12.5C298.521,263.754,263.754,298.521,221.02,298.521z"/>
          ...
          <svg width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg" className={postIconClassNames}>
